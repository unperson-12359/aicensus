...
This guide is about runtimes and tools — the software that runs the models. For which models to run on them, read [Running AI locally](/blog/run-ai-locally-open-source-models). Also browse [llama.cpp alternatives](/tools/llama-cpp/alternatives) in our directory or see the ranked [Best open-source AI tools](/best/open-source-ai-tools) list.
