...
export const CAPABILITIES: CapabilityDef[] = [
  ...
  },
  {
    ...
    toolSlugs: ["sora", "runway", "pika", "luma-dream-machine", "kling-ai", "heygen"],
  },
  {
    slug: "voice",
    name: "Voice & TTS",
  ...
  },
  {
    ...
    toolSlugs: ["figma-ai", "framer", "looka", "canva-ai", "gamma"],
  },
  {
    slug: "automation",
    name: "Automation & workflows",
    blurb: "No-code glue between apps",
    toolSlugs: ["zapier-ai", "make", "n8n", "composio"],
  },
  {
    slug: "agents",
  ...
  },
  {
    ...
    toolSlugs: ["notion-ai", "notebooklm", "glean"],
  },
];
