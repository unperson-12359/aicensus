...
export const BEST_FOR_PAGES: BestForPage[] = [
  ...
  },
  {
    ...
    picks: [
      ...
      { slug: "codeium", pitch: "The best free-tier completion option across VS Code and JetBrains — strong daily driver if you do not need full agent mode." },
  ...
  },
  {
    ...
    picks: [
      ...
      { slug: "gong", pitch: "Revenue intelligence from sales calls — useful when marketing needs real customer language, objections, and competitive mentions." },
      { slug: "semrush-ai", pitch: "SEO-first content workflow when your team already lives in Semrush for keywords, briefs, and competitive research." },
      ...
      { slug: "zendesk-ai", pitch: "Support-side AI for marketers who own customer experience — deflect tickets and keep brand voice consistent in replies." },
    ],
    faq: [
