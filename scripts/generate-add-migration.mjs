/**
 * Generates supabase/migrations/20260527001000_add_catalog_expansion_30.sql
 * Run: node scripts/generate-add-migration.mjs
 */
...
const tools = [
  {
    ...
    pricing_details:
      "Free tier with daily limits; Venice Pro about $18/month; API pay-as-you-go with Diem credits",
    editor_rating: 4.2,
  ...
  },
  {
    ...
    description:
      "Factory builds autonomous coding agents called Droids that integrate with GitHub, Jira, and Slack to implement features, fix bugs, and open pull requests. Enterprise teams use Factory to augment engineering velocity while keeping work inside existing SDLC workflows and security boundaries.",
  ...
  },
  {
    ...
    description:
      "Greptile builds a semantic index of your GitHub repositories and uses it to power AI code review, natural language codebase Q&A, and onboarding assistance. It understands cross-file dependencies and architectural patterns, making it useful for teams with large or legacy codebases where context retrieval is the bottleneck.",
    website_url: "https://greptile.com",
    category_slug: "coding-development",
    pricing_model: "freemium",
    pricing_details:
      "Free tier for small repos; Pro from about $20/user/month; Enterprise custom",
    editor_rating: 4.3,
  ...
  },
  {
    ...
    description:
      "E2B provides Firecracker microVM sandboxes that AI agents use to execute arbitrary code safely in the cloud. Developers integrate E2B via SDK to give coding agents, data analysis bots, and autonomous workflows an isolated runtime. Used by AI agent frameworks as the standard execution layer for untrusted code.",
    website_url: "https://e2b.dev",
    category_slug: "ai-agents",
    pricing_model: "freemium",
    pricing_details:
      "Free tier with sandbox hours; Pro from about $100/month; usage-based overage",
    editor_rating: 4.5,
    company_name: "E2B",
    founded_year: 2023,
    key_features: [
  ...
  },
  {
    ...
    description:
      "Browserbase provides managed headless browser sessions optimized for AI agents that need to navigate websites, fill forms, and extract data. It handles CAPTCHAs, proxies, and session persistence so developers can focus on agent logic rather than browser automation plumbing.",
    website_url: "https://browserbase.com",
    category_slug: "agents-automation",
    pricing_model: "freemium",
    pricing_details:
      "Free tier with session limits; Developer from about $99/month; Enterprise custom",
    editor_rating: 4.4,
  ...
  },
  {
    ...
    description:
      "Pipedream is a low-code automation platform where developers write JavaScript or Python steps connected to thousands of APIs. AI features help generate workflow code, and the platform supports triggers, scheduled jobs, and event-driven pipelines. Popular for connecting LLM APIs to business tools without managing infrastructure.",
    website_url: "https://pipedream.com",
    category_slug: "agents-automation",
    pricing_model: "freemium",
    pricing_details:
      "Free tier with daily credits; Advanced from about $29/month; Business custom",
    editor_rating: 4.3,
  ...
  },
  {
    ...
    pricing_model: "open_source",
    pricing_details:
      "Free open-source self-hosted; LiteLLM Cloud managed proxy with usage-based pricing",
    editor_rating: 4.5,
  ...
  },
  {
    ...
    description:
      "PulseMCP is the leading directory for Model Context Protocol servers, helping developers discover, compare, and integrate MCP tools into Claude, Cursor, and other MCP-compatible clients. It tracks server quality, documentation, and community ratings as the MCP ecosystem grows rapidly.",
  ...
  },
  {
    ...
    description:
      "Reve Image is an AI image generator that excels at rendering readable text, logos, and typography within generated images — a longstanding weakness of diffusion models. Designers and marketers use Reve for social graphics, posters, and branded visuals where text accuracy matters as much as visual quality.",
  ...
  },
  {
    ...
    description:
      "ComfyUI is a powerful node-based GUI for building complex Stable Diffusion and Flux image generation pipelines. Power users chain models, LoRAs, ControlNets, and upscalers visually without writing code. It is the standard tool for advanced AI image generation workflows in the open-source community.",
  ...
  },
  {
    ...
    description:
      "SOUNDRAW generates original, royalty-free background music tailored to mood, genre, and length using AI. Creators customize tracks by adjusting instruments, tempo, and energy without music production skills. Widely used by YouTubers, podcasters, and businesses needing affordable, copyright-safe music.",
    website_url: "https://soundraw.io",
    category_slug: "music-audio",
    pricing_model: "freemium",
    pricing_details:
      "Free preview and limited downloads; Creator about $17/month; Artist Pro about $37/month",
    editor_rating: 4.2,
  ...
  },
  {
    ...
    description:
      "Relume uses AI to generate sitemaps, wireframes, and style guides from a text brief, then exports directly to Webflow and Figma. Web designers and agencies use it to accelerate the discovery and wireframing phase of client projects, turning hours of planning into minutes of AI-assisted generation.",
    website_url: "https://relume.io",
    category_slug: "design-creative",
    pricing_model: "freemium",
    pricing_details:
      "Free tier with project limits; Starter about $32/month; Pro about $48/month",
    editor_rating: 4.4,
    company_name: "Relume",
    founded_year: 2022,
    key_features: [
  ...
  },
  {
    ...
    description:
      "Lex is a modern writing app built from the ground up with AI assistance — not bolted onto a traditional editor. It offers inline AI completions, tone adjustments, feedback requests, and collaborative editing. Writers who find Google Docs too basic and Notion too unstructured use Lex as their primary long-form writing environment.",
  ...
  },
  {
    ...
    description:
      "Exa (formerly Metaphor) provides a search API optimized for LLM retrieval — returning clean, structured web content rather than SEO-optimized snippets. AI agent developers and RAG pipeline builders use Exa to give their systems real-time, high-quality web knowledge with semantic search capabilities.",
    website_url: "https://exa.ai",
    category_slug: "research-search",
    pricing_model: "freemium",
    pricing_details:
      "Free tier with 1,000 searches/month; Pro from about $25/month; Enterprise custom",
    editor_rating: 4.4,
    company_name: "Exa",
    founded_year: 2021,
    key_features: [
  ...
  },
  {
    ...
    description:
      "SciSpace (formerly Typeset) is an AI-powered research platform for reading, understanding, and writing scientific papers. It explains complex passages, answers questions about PDFs, generates literature reviews, and helps with citation formatting. Used by 280M+ researchers worldwide as an AI copilot for academic work.",
  ...
  },
  {
    ...
    pricing_model: "freemium",
    pricing_details:
      "Free tier for individuals; Pro about $29/user/month; Enterprise custom",
    editor_rating: 4.3,
    company_name: "Dust",
    founded_year: 2023,
    key_features: [
  ...
  },
  {
    ...
    description:
      "Hex is a collaborative data workspace combining SQL, Python, and no-code cells with AI assistance for exploration, visualization, and sharing. Analytics teams use Hex instead of Jupyter notebooks for production-quality data apps with built-in collaboration, versioning, and stakeholder sharing without engineering overhead.",
    website_url: "https://hex.tech",
    category_slug: "data-analytics",
    pricing_model: "freemium",
    pricing_details:
      "Free tier for individuals; Team from about $36/user/month; Enterprise custom",
    editor_rating: 4.5,
  ...
  },
  {
    ...
    description:
      "Amazon Bedrock gives AWS customers access to foundation models from Anthropic, Meta, Mistral, Amazon, and others through a unified API with enterprise security, fine-tuning, and knowledge base integration. Enterprises already on AWS use Bedrock to deploy AI applications with VPC isolation, IAM controls, and existing cloud billing.",
...
const sql = `-- Add 30 catalog expansion tools (Q2 2026)
...
WITH new_tools AS (
  SELECT *
  FROM jsonb_to_recordset($tools$${json}$tools$::jsonb) AS t(
    slug text,
    name text,
    tagline text,
    description text,
...
const outPath = join(
  root,
  "supabase/migrations/20260527001000_add_catalog_expansion_30.sql"
);
